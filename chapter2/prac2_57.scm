...
(define (augend e) 
 (cond	((> (length (cddr e)) 1) (cons '+ (cddr e)))
		(else (caddr e))))
(define (make-sum a1 a2) 
 (cond  ((eq? a1 '0) a2)
		((eq? a2 '0) a1)
		((and (not (pair? a1)) (sum? a2)) (append '(+) (list a1) (cdr a2)))
		((and (not (pair? a2)) (sum? a1)) (append '(+) (cdr a1) (list a2)))
...
(define (make-product a1 a2)
 (cond  ((or (eq? a1 '0) (eq? a2 '0)) 0)
		...
		((and (product? a1) (product? a2)) (append '(*) (cdr a1) (cdr a2)))
		(else (list '* a1 a2))))
