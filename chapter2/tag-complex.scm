...
(define (magnitude-rectangular z)
 (sqrt (+ (* (real-part-rectangular z) (real-part-rectangular z))
		  (* (imag-part-rectangular z) (imag-part-rectangular z)))))
...
(define (make-from-real-imag-polar x y) (attach-tag 'polar (cons (sqrt (+ (* x x) (* y y)))
																 (atan (/ y x)))))
